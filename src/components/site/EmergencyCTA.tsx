...
import { PHONE, PHONE_DISPLAY } from "@/lib/assets";
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
      <div className="relative overflow-hidden rounded-3xl border border-primary/40 bg-gradient-to-br from-primary/20 via-card to-card p-8 md:p-14 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">Fast, reliable car recovery and roadside assistance across Birmingham, West Midlands & nationwide UK. Call now — help is on the way.</p>
